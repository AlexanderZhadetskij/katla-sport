...
const routes: Routes = [
  ...
  { path: 'hive/:hiveId/section/:id', component: HiveSectionFormComponent }, // added in 14 step
  { path: 'hive/:hiveId/section', component: HiveSectionFormComponent }, // added in 14 step
];
