...
namespace KatlaSport.WebApi.Controllers
{
    ...
    public class HiveSectionsController : ApiController
    {
        ...
        [HttpGet]
        [Route("")]
        [SwaggerResponse(HttpStatusCode.OK, Description = "Returns a list of hive sections.", Type = typeof(HiveSection[]))]
        ...
        [SwaggerResponse(HttpStatusCode.InternalServerError)]
        public async Task<IHttpActionResult> AddHiveSection([FromBody]UpdateHiveSectionRequest updateRequest)
        {
            ...
            var hiveSection = await _hiveSectionService.CreateHiveSectionAsync(updateRequest);
            var location = string.Format("/api/hiveSections/{0}", hiveSection.Id);
